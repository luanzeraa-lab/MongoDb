...
//    {_id:6 , "item":"def", "price":Decimal128("7.5"), "quantity": Int32("5"), "date": ISODate("2014-04-04T05:08:13Z") },
//     {_id:7 , "item":"def", "price":Decimal128("7.5"), "quantity": Int32("10"), "date": ISODate("2014-04-06T05:08:13Z") },
//     {_id:8 , "item":"xyz", "price":Decimal128("5"), "quantity": Int32("10"), "date": ISODate("2014-04-06T05:08:13Z") }
// ])
...
//         $group: {
//             _id: "price",
//             mediaPreco: {$avg: "$price" }
//         }
//     }
// ]))

console.log(db.sales.aggregate([
